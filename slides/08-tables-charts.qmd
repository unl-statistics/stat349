...
::: {.incremental}
- Table titles should be informative    
[(but don't have to include all the details req'd in SWHR)]{.small}

- Tables should use significant figures

- Tables should have a consistent number of decimal places in each column
...
- Colorblind friendly is important
- Dual encoding (shape/linetype + color) helps a lot

- Grid lines are a good thing (you're wrong, SWHR!)

- 3D graphs only work if you 3d print them    
[Ok, I don't have proof of this yet, but I'm working on it...]{.small .emph .blue}

- Figure titles - above, below        
[conform to the style guide you're using]{.emph .red}

- Don't make graphs in MS Word or Excel. Just... don't. 
...
This is great if you can manage it, but LaTeX doesn't make it easy. 

[Don't override your document format's general workings to adhere to guidelines.]{.emph .cerulean .fragment} 

[Simple formatting is better.]{.fragment}

## Case Study: What makes a chart useful?

From Getting (more out of) Graphics Ch. 8 -- See Library Course Materials

- International Chess Federation ranking system    
(Data from WorldBank website)

- 362502 players: name, country, rating, year of birth

::: {.fragment}
Guiding questions:

- What is the distribution of ratings?
- How does rating change with age?
- How does gender affect rating?
- Which countries have highest-rated players?
:::

[[R Code](08-tables-charts.R) to follow along]{.fragment}
...
## Fig 8.4 'Density estimates of distributions of ratings for active and inactive players'
...
boxplot widths are proportional to the square roots of the sizes of the groups and outliers are drawn in red
...
## Fig 8.8 'Differences between the ratings of the top 1000 male and top 1000 female players in December 2020'
...
## Fig 8.10 'Age distributions of active players'
(females in purple)
...
## Fig 8.11 'Numbers of active rated players by country'
...
circle areas are proportional to country population sizes
...
## Fig 8.14 'Density estimates of distributions of ratings in December 2015 and December 2020'
...
(players with ratings over 2700 are colored red and an alpha value of 0.01 has been used for the others)
