...
We will also read sections from [Entering the Conversation](https://wisc.pb.unizin.org/opencomp/front-matter/intro/), an open composition textbook by Naomi Salmon (Ed), as this course contains elements of both technical writing and more general composition. 

Other useful resources have been added to the course canvas page. All books and resources used in this course are available online or through the UNL library free of charge.
...
You will have weekly reading assignments which introduce the weekly focus area. In order to motivate the importance of this reading, you will be given a weekly reading quiz on Canvas which covers the requisite material. These quizzes will be due before the first class of the week.
...
You will complete two major projects in this course: a business-style report and presentation, and a research-style paper and poster. These projects will be due during the second half of the semester, and will involve both in-person presentations and peer evaluations of other students' work.
...
You are expected to attend class. Consistent, repeated failure to attend class or actively participate in the course will affect the participation portion of your grade.
