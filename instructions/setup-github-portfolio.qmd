...
1. Create a github repository that is named "portfolio" and located at [https://github.com/\<username\>/portfolio](https://github.com/<username>/portfolio)
...
If you're feeling fancy, you can automate this process using a GitHub action, but this is fiddly and probably not worth it unless you're actually planning to use this as a blog and update it frequently. 
If you decide to set everything up with Github Actions, that is fine, but I can only offer a minimal amount of help with debugging. 
